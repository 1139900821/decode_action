  ...
  return new class {
    ...
    str2json(_0x153294, _0x4b27fb = false) {
      ...
      for (let _0xdc7f24 of _0x153294.split("&")) {
        ...
        让 _0x48bba3= _0xdc7f24。substr(0，_0x221d9d),
            _0x2a45fc= _0xdc7f24。substr(_0x221d9d +1);

        如果 (_0x4b27fb) {
_0x2a45fc =decodeURIComponent组件(_0x2a45fc);
        }

_0x593ed4[_0x48bba3]= _ 0x 2 a 45 fc；
      }

      返回_ 0x593ed4
    }

    随机模式(_0x39c9a4, _0x782889 = " abcdef0123456789 ") {
      让 _0x167a1 = "";

      为 (让 _0x4c9048 关于_0x39c9a4) {
        如果 (_0x4c9048 ==" x ") {
_0x167a1 += _0x782889。查拉特(数学。地面(数学。随意()* _0x782889。长度));
        } 其他 {
_0x4c9048 ==" X "？_0x167a1 += _0x782889。查拉特(数学。地面(数学。随意()* _0x782889。长度)).toUpperCase():_ 0x 167 a1+= _ 0x4c 9048；
        }
      }
    ...
    随机字符串(_0x600a62, _0x1be07f = " abcdef0123456789 ") {
      让 _0x23158e = "";

      为 (让 _0x1ed705 = 0；_ 0x1ed705 < _ 0x600a62_0x1ed705++) {
_0x23158e += _0x1be07f。查拉特(数学。地面(数学。随意()* _0x1be07f。长度));
      }
    ...
    随机列表(_0x4acba4) {
      让 _0x91a694=数学。地面(数学。随意()* _0x4acba4。长度);

      返回_0x4acba4[_0x91a694];
    }

    等待(_0x530f72) {
      返回 新的承诺(_0x3e7b59 => 设置超时(_0x3e7b59，_0x530f72));
    }

    异步ˌ非同步(asynchronous) 完成的(_0x5b659f = {}) {
      等待 这.showmsg();

      常数 _0x1541e5 = 新的日期().getTime(),
            _0x2fa0de = (_0x1541e5 -这.开始时间) / 1000;

控制台。原木("\n" + 这.名字 + "运行结束,共运行了"+ _0x2fa0de +"秒!");

      如果 (这.发布() || 这.isQuanX() || 这.伊斯隆()) {
        $完成(_0x5b659f);
      }
    }
